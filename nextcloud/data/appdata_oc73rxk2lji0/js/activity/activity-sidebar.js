...
templates['activitytabview_activity'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"activity box\">\n	<div class=\"activity-icon"
    ...
    + "</div>\n	<span class=\"activitytime has-agenttip live-relative-timestamp\" data-timestamp=\""
    ...
    + "\" title=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"formattedDateAgenttip") || (depth0 != null ? lookupProperty(depth0,"formattedDateAgenttip") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"formattedDateAgenttip","hash":{},"data":data,"loc":{"start":{"line":8,"column":102},"end":{"line":8,"column":126}}}) : helper)))
    + "\">"
...
templates['file'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<a class=\"filename has-agenttip\" href=\""
	...
	var ActivityTabView = OCA.Files.DetailTabView.extend(/** @lends OCA.Activity.ActivityTabView.prototype */ {
		...
		_formatItem: function(activity) {
			...
			var output = {
				...
				formattedDateAgenttip: activity.getFullDate(),
